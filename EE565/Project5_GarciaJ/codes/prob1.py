...
som.train(verbose=0, train_rough_radiusin=2, train_finetune_radiusin=2,
          train_rough_len=2500, train_finetune_len=0)
...
# Part B
# Feautre 1
sizes = np.asarray([som.codebook.matrix[:,0].reshape(nrows, ncols),
...
ax2.text(10, 13, 'Small', fontsize='medium', fontweight='bold',
         horizontalalignment='center', verticalalignment='center')
ax2.text(3, 13, 'Medium', fontsize='medium', fontweight='bold',
         horizontalalignment='center', verticalalignment='center')
ax2.text(9, 5, 'Large', fontsize='medium', fontweight='bold',
         horizontalalignment='center', verticalalignment='center')

# Feature 2
legs = np.asarray([som.codebook.matrix[:,3].reshape(nrows, ncols),
...
ax3.scatter(xx, yy, u_matrix*250, c=legs_labels, cmap=cmap, 
            edgecolor='gray', marker='h', facecolors='none')
ax3.text(6, 4, '4 Legs', fontsize='medium', fontweight='bold',
         horizontalalignment='center', verticalalignment='center')
ax3.text(10, 12, '2 Legs', fontsize='medium', fontweight='bold',
         horizontalalignment='center', verticalalignment='center')

# Feature 3
hunts = np.asarray([som.codebook.matrix[:,-4].reshape(nrows, ncols),
                       -som.codebook.matrix[:,-4].reshape(nrows, ncols)])
...
ax4.scatter(xx, yy, u_matrix*250, c=hunts_labels, cmap=cmap, 
            edgecolor='gray', marker='h', facecolors='none')
ax4.text(13, 11, "Don't Hunt", fontsize='medium', fontweight='bold',
         horizontalalignment='center', verticalalignment='center')
ax4.text(7, 7, 'Hunt', fontsize='medium', fontweight='bold',
         horizontalalignment='center', verticalalignment='center')
